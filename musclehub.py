...
#plt.show()
plt.savefig('Percent_Application.png')
...
ax.set_xticklabels(xlabels)
ax.set_yticks([.4, .55,.7,.85,1])
ax.set_yticklabels(['40%','55%','70%','85%', '100%'])
plt.title('Percent Purchase of Applicants')
#plt.show()
plt.savefig('Purchase_Applicants.png')
...
ax.set_yticks([0, 0.05, 0.1, 0.15, .2])
ax.set_yticklabels(['0','5%','10%','15%', '20%'])
plt.title('Percent Purchase of Visitors')
#plt.show()
plt.savefig('Purchase_Visitors.png')
